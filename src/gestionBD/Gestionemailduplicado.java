...
public class Gestionemailduplicado {
	public Usuario obteneremailduplicado(Usuario usu1) {
		...
		try {
			...
			pst1.setString(1, usu1.getEmail());
			...
			System.out.println("error en obtener el email");
		}
		return usuario1;
	}
